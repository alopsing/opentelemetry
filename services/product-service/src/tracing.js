...
const sdk = new NodeSDK({
  ...
  instrumentations: [
    getNodeAutoInstrumentations({
      ...
      // Disable pg from auto-instrumentations so we use the dedicated one below
      '@opentelemetry/instrumentation-pg': { enabled: false },
    }),
    // Dedicated pg instrumentation — captures db.statement, db.system, net.peer.name, etc.
    new PgInstrumentation({
      enhancedDatabaseReporting: true, // includes sanitized query params in spans
    }),
  ],
});
